...
def generate():
    url = 'https://www.kommersant.ru/authors/406'
    ...
    fg = FeedGenerator()
    fg.title('Александр Черных — Коммерсантъ')
    fg.link(href=url, rel='alternate')
    fg.description('Лента материалов Александра Черных на kommersant.ru')
    fg.language('ru')
