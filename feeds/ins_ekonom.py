...
def generate():
    ...
    URL = f'{BASE_URL}/ekonomika'
    OUTPUT_FILE = 'ins_ekonom.xml'
    ...
    fg = FeedGenerator()
    fg.title('The Insider — Экономика')
    fg.link(href=URL, rel='alternate')
    fg.description('RSS-лента с раздела "Экономика" сайта The Insider')
    ...
    print("✅ ins_ekonom: сгенерирован ins_ekonom.xml")
