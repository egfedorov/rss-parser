...
def generate():
    url = "https://novayagazeta.eu/authors/161"
    ...
    fg = FeedGenerator()
    fg.id(url)
    fg.title("Новая Газета Европа — публикации Дениса Морохина")
    fg.link(href=url, rel="alternate")
    fg.description("Лента статей Дениса Морохина с сайта novayagazeta.eu")
    fg.language("ru")
