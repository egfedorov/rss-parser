...
def generate():
    url = "https://novayagazeta.eu/authors/330"
    ...
    fg = FeedGenerator()
    fg.id(url)
    fg.title("Новая Газета Европа — публикации Алеси Соколовой")
    fg.link(href=url, rel="alternate")
    fg.description("Лента статей Алеси Соколовой с сайта novayagazeta.eu")
    fg.language("ru")
