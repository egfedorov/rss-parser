...
def generate():
    ...
    fg = FeedGenerator()
    fg.title('The Insider — Расследования')
    fg.link(href=URL, rel='alternate')
    fg.description('RSS-лента раздела «Расследования» сайта The Insider')
    fg.language('ru')
    ...
    print(f"✅ theins: сгенерирован feed_theins.xml ({len(seen_links)} статей)")
